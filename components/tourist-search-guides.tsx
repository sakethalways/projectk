...
import TouristGuideCard from '@/components/tourist-guide-card';
...
export default function TouristSearchGuides() {
  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="border border-border p-6 sm:p-8 bg-white dark:bg-slate-800">
        <div className="mb-6">
          ...
          {guides.length === 0 ? (
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {guides.map((guide) => (
                  <TouristGuideCard key={guide.id} guide={guide} />
                ))}
              </div>
            </div>
          )}
