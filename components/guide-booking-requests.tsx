...
import { Alert, AlertDescription } from '@/components/ui/alert';import { Avatar, AvatarImage, AvatarFallback } from '@/components/ui/avatar';import type { Booking } from '@/lib/supabase-client';
import { Loader2, AlertCircle, CheckCircle, XCircle, BookOpen } from 'lucide-react';
  ...
  useEffect(() => {
    const loadRequests = async () => {
      try {
        ...
        const response = await fetch('/api/get-guide-bookings', {
          headers: {
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-foreground">
                        {booking.tourist ? `Tourist: ${booking.tourist.name}` : 'Tour Request'}
                      </h3>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-semibold text-foreground">{new Date(viewingItinerary.booking_date).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</p>
                </div>
                <div>
